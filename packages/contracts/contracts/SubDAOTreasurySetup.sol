...
import {SubDAORoles} from "./SubDAOTreasury.sol";
...
contract SubDAORolesSetup is PluginSetup {
    ...
    constructor() {
        implementation_ = address(new SubDAOTreasury());
    }
        ...
        returns (address plugin, PreparedSetupData memory preparedSetupData)
    {
        ...
        permissions[0] = PermissionLib.MultiTargetPermission(
            ...
            SubDAOTreasury(plugin).SUBDAO_EXECUTE_PERMISSION_ID();
        );
        ...
        permissions[1] = PermissionLib.MultiTargetPermission(
            ...
            plugin,
            PermissionLib.NO_CONDITION,
            DAO(payable(_dao)).SUBDAO_EXECUTE_PERMISSION_ID();
        );
