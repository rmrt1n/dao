...
contract nftGovernance is Plugin{
    ...
    bytes32 public constant ADMIN_EXECUTE_PERMISSION_ID = keccak256('ADMIN_EXECUTE_PERMISSION');//keep
   ...
   // constructor(string memory name, string memory symbol) ERC721(name,symbol){}
    ...
    function setGovernance(address nftcontract, uint256 tokenID) external auth(ADMIN_EXECUTE_PERMISSION_ID){
        ...
        require(IERC721(nftcontract).ownerOf(tokenID) == address(this), "NFT is not owned by the contract");
